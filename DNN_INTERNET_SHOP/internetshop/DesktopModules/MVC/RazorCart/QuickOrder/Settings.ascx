<%@ Control Language="C#" EnableViewState="true" AutoEventWireup="true" CodeBehind="Settings.ascx.cs" Inherits="RazorCart.QuickOrder.Settings" %>
...
<div id="rzcModuleSettings">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            <div class="dnnLabel">
                <label><span><asp:Literal runat="server" ID="lblEntryFormSize"></asp:Literal></span></label>
            </div>
            <asp:TextBox runat="server" ID="txtEntryFormSize"></asp:TextBox>
        </div>
        <!-- Add To Cart Event -->
        <div class="dnnFormItem">
            <div class="dnnLabel">
